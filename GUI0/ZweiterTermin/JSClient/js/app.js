...
document.getElementById("btnPushSudoku").addEventListener("click", function(){
   var dir = document.getElementById("directory").value
  var myMessage = compressMyMessage("push:" + getStringSudoku()+":"+dir);
  log("Git Push...");
  connection.send(myMessage);

});

document.getElementById("btnPullSudoku").addEventListener("click", function(){
  var dir = document.getElementById("directory").value
  var myMessage = compressMyMessage("pull:"+dir);
  log("Git Pull...");
  connection.send(myMessage);
...
document.getElementById("btnSolve").addEventListener("click", function(){
  ...
  var myMessage = compressMyMessage("solve:" + getStringSudoku());
...
function getJSONSudoku() {
  ...
  for(var i = 0; i<sudokuSize; i++) {
    ...
    myString += "[";
    for(var j = 0; j<sudokuSize; j++) {
      var s = document.getElementById(i+"_"+j).value;
      if(s === ""){
        s = "0";
      }
      myString += s;
